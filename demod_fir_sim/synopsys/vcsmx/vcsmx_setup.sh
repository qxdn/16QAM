...
# ACDS 18.1 625 win32 2020.12.18.19:27:43
...
# ----------------------------------------
# If demod_fir is one of several IP cores in your
...
TOP_LEVEL_NAME="demod_fir"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/program/quartus/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/demod_fir_rtl_core.vhd"                         
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/demod_fir_ast.vhd"                              
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/demod_fir.vhd"                                  
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/demod_fir_tb.vhd"                               
fi
